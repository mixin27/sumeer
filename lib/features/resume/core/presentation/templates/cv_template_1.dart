...
Future<Uint8List> generateCVTemplate1(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    if (resumeData.profile!.contents.isNotEmpty) ...[
                      _buildTitleWidget("PROFILE", const pw.IconData(0xea67),
                          PdfColor.fromHex('293F4E'), PdfColors.white),
                      pw.SizedBox(height: 10),
                      pw.SizedBox(height: 30),
                    ],
                    if (resumeData.languages != null) ...[
                      _buildTitleWidget("LANGUAGES", const pw.IconData(0xe894),
                          PdfColor.fromHex('293F4E'), PdfColors.white),
                      pw.SizedBox(height: 10),
                      pw.Column(
                    ...
                    if (resumeData.award != null) ...[
                      _buildTitleWidget("AWARDS", const pw.IconData(0xea23),
                          PdfColor.fromHex('293F4E'), PdfColors.white),
                      pw.SizedBox(height: 10),
                      pw.Column(
                        crossAxisAlignment: pw.CrossAxisAlignment.start,
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    if (resumeData.education != null) ...[
                      _buildTitleWidget("EDUCATION", const pw.IconData(0xe80c),
                    ...
                    if (resumeData.skill != null) ...[
                      _buildTitleWidget("SKILLS", const pw.IconData(0xea23),
                          PdfColor.fromHex('EFEFEF'), PdfColors.black),
                      pw.SizedBox(height: 10),
                      pw.Column(
