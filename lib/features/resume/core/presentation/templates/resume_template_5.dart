                ...
                child: pw.Column(
                  ...
                  children: [
                        ...
                        children: [
                          pw.Column(
                              ...
                              children: [
                                // name
                                pw.Row(children: [
                                  // if (resumeData.personalDetail?.fullName !=
                                  //     null)
                                  //   pw.Text(
                                      ...
                                      text: pw.TextSpan(
                                        ...
                                        children: [
                                          if (resumeData
                                              ...
                                              null)
                                            pw.TextSpan(
                                              text: resumeData.personalDetail
                                                      ?.fullName ??
                                                  '',
                                              style: pw.Theme.of(context)
                                                  .defaultTextStyle
                                  ...
                                  pw.SizedBox(width: 8),
                                  // job
                                  // if (resumeData.personalDetail?.jobTitle !=
                                  //     null) ...[
                                  //   pw.Padding(
                                  //     padding:
                                  //         const pw.EdgeInsets.only(top: 30),
                                  //   ),
                                  //   pw.Text(
                                ...
                                // address
                                if (resumeData.personalDetail?.address !=
                                    null) ...[
                                  pw.Padding(
                                  ...
                                  pw.Text(
                                    ...
                                    textScaleFactor: 1.2,
                                    style:
                                        pw.Theme.of(context).defaultTextStyle,
                                  ),
                                ],
                                // phone
                    ...
                    if (resumeData.personalDetail != null) ...[
                      SectionDesign5(title: 'Personal Detail'),
                    ...
                    if (resumeData.profile != null) ...[
                      if (resumeData.profile?.title != null)
                        SectionDesign5(title: resumeData.profile?.title ?? ''),
                      if (resumeData.profile!.contents.isNotEmpty)
                        pw.Column(
                    ...
                    if (resumeData.skill != null) ...[
                      if (resumeData.skill?.title != null)
                        SectionDesign5(title: resumeData.skill?.title ?? ''),
                    ...
                    if (resumeData.interest != null) ...[
                      if (resumeData.interest?.title != null)
                        SectionDesign5(title: resumeData.interest?.title ?? ''),
