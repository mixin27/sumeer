...
Future<Uint8List> generateTemplate12(
...
Future<pw.PageTheme> _pageTheme(PdfPageFormat format, PdfColor color) async {
  ...
  return pw.PageTheme(
    ...
    theme: pw.ThemeData.withFont(
      // Vollkorn
      base: await PdfGoogleFonts.vollkornRegular(),
      bold: await PdfGoogleFonts.vollkornBlack(),
