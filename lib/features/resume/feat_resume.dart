export 'data/dummy_resume_data.dart';
...
export 'core/presentation/widgets/widgets.dart';

export 'core/application/add_resume_data_notifier.dart';
export 'core/application/upsert_resume_data_notifier.dart';

export 'core/shared/constants/pdf_constants.dart';
export 'core/shared/constants/firestore_consts.dart';
export 'core/shared/enums.dart';
export 'core/shared/providers/resume_providers.dart';
...
export 'template_listing/presentation/template_listing_page.dart';
